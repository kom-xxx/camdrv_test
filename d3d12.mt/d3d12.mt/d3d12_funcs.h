...
void create_target_buffer(ID3D12Device *, render_heap *, size_t, size_t,
			  ID3D12Resource **);
void acquire_target_buffers(ID3D12Device *, render_heap *, render_output *,
                            size_t, size_t);
...
void create_rtv(ID3D12Device *, IDXGISwapChain *, render_output *);
...
void render_core(thread_arg *, render_global *, thread_resources *, uint64_t);

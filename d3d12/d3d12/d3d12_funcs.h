...
transition_barrier(ID3D12Resource *res,
		   ...
		   D3D12_RESOURCE_STATES after
		   	= D3D12_RESOURCE_STATE_COMMON,
		   D3D112_RESOURCE_BARRIER_FLAGS flags
...
void create_upload_buffer(ID3D12Device *, render_heap *, size_t,
                          ID3D12Resource **);
void create_texture_heap(ID3D12Device *, render_heap *, size_t);
void create_texture_buffer(ID3D12Device *, render_heap *, size_t, size_t,
                           ID3D12Resource **);
void create_vbv(ID3D12Device *, render_input *);
void create_ibv(ID3D12Device *, render_input *);

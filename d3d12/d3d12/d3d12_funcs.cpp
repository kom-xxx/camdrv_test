               ...
               ID3D12Resource *dst, ID3D12Resource *src)
{
    ...
    cmd->list->CopyTextureRegion(&dst, 0, 0, 0, &src, nullptr);
 ...
 ***/
void
create_vbv(ID3D12Device *dev, render_input *in)
{
    HRESULT hr;
...
void
create_ibv(ID3D12Device *dev, render_input *in)
{
    uint16_t indexes[] = {
        0, 1, 2,
        2, 1, 3
